"use strict";(()=>{function d(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function b(e){try{let t=new URL(e);if(t.protocol==="http:"||t.protocol==="https:")return e}catch{}return""}function g(e,t){document.getElementById("modal-overlay")?.remove();let r=document.createElement("div");r.id="modal-overlay",r.className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50";let a=document.createElement("div");a.className="bg-gray-800 border border-gray-700 rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl";let n=document.createElement("p");n.className="text-white text-center mb-6 text-base leading-relaxed",n.textContent=e,a.appendChild(n);let l=document.createElement("div");if(l.className="flex gap-3 justify-center",t){let c=document.createElement("button");c.className="flex-1 py-2.5 rounded-xl bg-gray-600 hover:bg-gray-500 text-white font-semibold transition",c.textContent="\u041E\u0442\u043C\u0435\u043D\u0430",c.onclick=()=>r.remove(),l.appendChild(c);let x=document.createElement("button");x.className="flex-1 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-semibold transition",x.textContent="\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C",x.onclick=()=>{r.remove(),t()},l.appendChild(x)}else{let c=document.createElement("button");c.className="px-10 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold transition",c.textContent="OK",c.onclick=()=>r.remove(),l.appendChild(c)}a.appendChild(l),r.appendChild(a),r.addEventListener("click",c=>{c.target===r&&r.remove()}),document.body.appendChild(r)}function G(e){let t=Math.floor((Date.now()-e)/6e4);if(t<1)return"\u0442\u043E\u043B\u044C\u043A\u043E \u0447\u0442\u043E";if(t<60)return`${t} \u043C\u0438\u043D. \u043D\u0430\u0437\u0430\u0434`;let r=Math.floor(t/60);return r<24?`${r} \u0447. \u043D\u0430\u0437\u0430\u0434`:`${Math.floor(r/24)} \u0434. \u043D\u0430\u0437\u0430\u0434`}function U(e,t){let r=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(r),n=document.createElement("a");n.href=a,n.download=t,n.click(),URL.revokeObjectURL(a)}var D="clu_packs",K="clu_character_sets",N="clu_saves";function T(){try{let e=JSON.parse(localStorage.getItem(D)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function C(e){localStorage.setItem(D,JSON.stringify(e))}function I(){try{let e=JSON.parse(localStorage.getItem(K)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function M(e){localStorage.setItem(K,JSON.stringify(e))}function f(){try{let e=JSON.parse(localStorage.getItem(N)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function H(e){let t=f(),r=t.findIndex(l=>l.id===e.id),a=e.unlockedUpTo>=0?e.characterSet.characters[e.unlockedUpTo]?.name??"":"",n={id:e.id,playerName:e.playerName,packTitle:e.pack.title,charName:a,questionProgress:`${e.currentIndex+1} / ${e.shuffledQuestions.length}`,totalStars:e.totalStars,savedAt:Date.now(),state:e};r>=0?t[r]=n:t.unshift(n),localStorage.setItem(N,JSON.stringify(t))}function P(e){let t=f().filter(r=>r.id!==e);localStorage.setItem(N,JSON.stringify(t))}async function V(){try{let t=await(await fetch("packs/index.json")).json();return Promise.all(t.map(r=>fetch(`packs/${r}`).then(a=>a.json())))}catch{return[]}}async function Y(){try{let t=await(await fetch("characters/index.json")).json();return Promise.all(t.map(r=>fetch(`characters/${r}`).then(a=>a.json())))}catch{return[]}}var o=null,j=null,h=0,w=()=>{},Z=[],ee=[];function te(e){w=e}async function re(){[Z,ee]=await Promise.all([V(),Y()])}function ae(){return f().length>0}function be(){return[...Z,...T()]}function fe(){return[...ee,...I()]}function se(e){let t=be(),r=fe(),a=t.length>0&&r.length>0;if(e.innerHTML=`
  ...
  `,a){let n=e.querySelector("#sel-pack"),l=e.querySelector("#sel-chars"),c=()=>{let x=t[parseInt(n.value)],v=r[parseInt(l.value)],u=e.querySelector("#compat-warning");if(!x||!v){u.innerHTML="";return}let p=x.questions.length*x.starsPerCorrect,m=[...v.characters].sort((A,me)=>A.cost-me.cost),k=m[m.length-1]?.cost??0,z=m.filter(A=>A.cost<=p).length;z===0?u.innerHTML=`<div class="mt-2 px-3 py-2 bg-red-950 border border-red-800 rounded-xl text-red-300 text-xs">
  ...
  `,document.body.appendChild(r),r.querySelector("#btn-unlock-ok")?.addEventListener("click",()=>{r.remove(),t()})}function X(){if(o){if(o.currentIndex++,o.currentIndex>=o.shuffledQuestions.length){P(o.id),Se(),w("results");return}H(o),Q()}}function Se(){if(!o)return;let e=document.getElementById("screen-results"),t=o.characterSet.characters,r=o.unlockedUpTo>=0?t.slice(0,o.unlockedUpTo+1):[],a=o.unlockedUpTo>=0?t[o.unlockedUpTo]??null:null,n=(l,c)=>{let x=l?b(l):"";return x?`<img src="${x}" alt="" class="${c}" />`:`<div class="${c} bg-gray-700 flex items-center justify-center text-4xl">\u2B50</div>`};e.innerHTML=`
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-950">
      ...
      <div class="text-gray-400 mb-8 text-sm">
        ${o.shuffledQuestions.length} \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432 \xB7 ${o.totalStars} \u0437\u0432\u0451\u0437\u0434 \u043D\u0430\u0431\u0440\u0430\u043D\u043E
      </div>
  ...
  `,e.querySelector("#btn-home")?.addEventListener("click",()=>{o=null,w("home")})}var B=()=>{};function oe(e){B=e}var i=le();function le(){return{packs:[],view:"list",editIdx:-1,pack:{title:"",questions:[],starsPerCorrect:3},expandedQ:-1}}function de(e){i=le(),i.packs=T(),$(e)}function $(e){i.view==="list"?O(e):$e(e)}function O(e){e.innerHTML=`
  ...
  `;let r=e.querySelector("#pe-title"),a=e.querySelector("#pe-stars");r.addEventListener("input",()=>{i.pack.title=r.value}),a.addEventListener("input",()=>{i.pack.starsPerCorrect=Math.max(1,parseInt(a.value)||1)}),e.querySelector("#pe-edit-back")?.addEventListener("click",()=>{i.view="list",i.packs=T(),$(e)}),e.querySelector("#pe-save")?.addEventListener("click",()=>{if(!i.pack.title.trim()){g("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043F\u0430\u043A\u0435\u0442\u0430");return}i.editIdx===-1?i.packs.push(i.pack):i.packs[i.editIdx]=i.pack,C(i.packs),i.view="list",$(e)}),e.querySelector("#pe-del-pack")?.addEventListener("click",()=>{g(`\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u0430\u043A\u0435\u0442 \xAB${d(i.pack.title)}\xBB?`,()=>{i.packs.splice(i.editIdx,1),C(i.packs),i.view="list",$(e)})}),e.querySelector("#pe-add-q")?.addEventListener("click",()=>{i.pack.questions.push({text:"",answer:"",imageUrl:""}),i.expandedQ=i.pack.questions.length-1,J(e),setTimeout(()=>{e.querySelector(`[data-qrow="${i.expandedQ}"]`)?.scrollIntoView({behavior:"smooth",block:"center"})},50)}),xe(e)}function ce(e){return e.length===0?'<div class="text-gray-500 text-center py-8 text-sm">\u041D\u0435\u0442 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432. \u041D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB+ \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C\xBB.</div>':e.map((t,r)=>{let a=i.expandedQ===r;return`
  ...
  `;let a=()=>{t.querySelectorAll("[data-resume]").forEach(n=>{n.addEventListener("click",()=>{t.remove(),ne(n.dataset.resume)})}),t.querySelectorAll("[data-delete]").forEach(n=>{n.addEventListener("click",()=>{g("\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u044D\u0442\u043E \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435?",()=>{P(n.dataset.delete);let l=t.querySelector("#sp-list");l&&(l.innerHTML=r()),a(),f().length===0&&(t.remove(),_())})})})};a(),t.querySelector("#sp-close")?.addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()}),document.body.appendChild(t)}async function Te(){te(q),oe(q),await re(),q("home")}document.addEventListener("DOMContentLoaded",()=>{Te()});})();
