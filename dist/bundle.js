"use strict";(()=>{function d(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function b(e){try{let t=new URL(e);if(t.protocol==="http:"||t.protocol==="https:")return e}catch{}return""}function g(e,t){document.getElementById("modal-overlay")?.remove();let r=document.createElement("div");r.id="modal-overlay",r.className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50";let a=document.createElement("div");a.className="bg-gray-800 border border-gray-700 rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl";let n=document.createElement("p");n.className="text-white text-center mb-6 text-base leading-relaxed",n.textContent=e,a.appendChild(n);let l=document.createElement("div");if(l.className="flex gap-3 justify-center",t){let c=document.createElement("button");c.className="flex-1 py-2.5 rounded-xl bg-gray-600 hover:bg-gray-500 text-white font-semibold transition",c.textContent="\u041E\u0442\u043C\u0435\u043D\u0430",c.onclick=()=>r.remove(),l.appendChild(c);let x=document.createElement("button");x.className="flex-1 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-semibold transition",x.textContent="\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044C",x.onclick=()=>{r.remove(),t()},l.appendChild(x)}else{let c=document.createElement("button");c.className="px-10 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold transition",c.textContent="OK",c.onclick=()=>r.remove(),l.appendChild(c)}a.appendChild(l),r.appendChild(a),r.addEventListener("click",c=>{c.target===r&&r.remove()}),document.body.appendChild(r)}function G(e){let t=Math.floor((Date.now()-e)/6e4);if(t<1)return"\u0442\u043E\u043B\u044C\u043A\u043E \u0447\u0442\u043E";if(t<60)return`${t} \u043C\u0438\u043D. \u043D\u0430\u0437\u0430\u0434`;let r=Math.floor(t/60);return r<24?`${r} \u0447. \u043D\u0430\u0437\u0430\u0434`:`${Math.floor(r/24)} \u0434. \u043D\u0430\u0437\u0430\u0434`}function A(e,t){let r=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),a=URL.createObjectURL(r),n=document.createElement("a");n.href=a,n.download=t,n.click(),URL.revokeObjectURL(a)}var D="clu_packs",K="clu_character_sets",N="clu_saves";function q(){try{let e=JSON.parse(localStorage.getItem(D)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function C(e){localStorage.setItem(D,JSON.stringify(e))}function I(){try{let e=JSON.parse(localStorage.getItem(K)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function M(e){localStorage.setItem(K,JSON.stringify(e))}function f(){try{let e=JSON.parse(localStorage.getItem(N)??"[]");return Array.isArray(e)?e:[]}catch{return[]}}function H(e){let t=f(),r=t.findIndex(l=>l.id===e.id),a=e.unlockedUpTo>=0?e.characterSet.characters[e.unlockedUpTo]?.name??"":"",n={id:e.id,playerName:e.playerName,packTitle:e.pack.title,charName:a,questionProgress:`${e.currentIndex+1} / ${e.shuffledQuestions.length}`,totalStars:e.totalStars,savedAt:Date.now(),state:e};r>=0?t[r]=n:t.unshift(n),localStorage.setItem(N,JSON.stringify(t))}function j(e){let t=f().filter(r=>r.id!==e);localStorage.setItem(N,JSON.stringify(t))}async function V(){try{let t=await(await fetch("packs/index.json")).json();return Promise.all(t.map(r=>fetch(`packs/${r}`).then(a=>a.json())))}catch{return[]}}async function Y(){try{let t=await(await fetch("characters/index.json")).json();return Promise.all(t.map(r=>fetch(`characters/${r}`).then(a=>a.json())))}catch{return[]}}var i=null,P=null,y=0,h=()=>{},Z=[],ee=[];function te(e){h=e}async function re(){[Z,ee]=await Promise.all([V(),Y()])}function ae(){return f().length>0}function fe(){return[...Z,...q()]}function he(){return[...ee,...I()]}function se(e){let t=fe(),r=he(),a=t.length>0&&r.length>0;if(e.innerHTML=`
  ...
  `,a){let n=e.querySelector("#sel-pack"),l=e.querySelector("#sel-chars"),c=()=>{let x=t[parseInt(n.value)],v=r[parseInt(l.value)],u=e.querySelector("#compat-warning");if(!x||!v){u.innerHTML="";return}let p=x.questions.length*x.starsPerCorrect,m=[...v.characters].sort((U,be)=>U.cost-be.cost),k=m[m.length-1]?.cost??0,z=m.filter(U=>U.cost<=p).length;z===0?u.innerHTML=`<div class="mt-2 px-3 py-2 bg-red-950 border border-red-800 rounded-xl text-red-300 text-xs">
  ...
  `,document.body.appendChild(n);let c=()=>{n.remove(),e&&t>0&&ie(t)};n.querySelector("#btn-close-overlay")?.addEventListener("click",c),n.addEventListener("click",x=>{x.target===n&&c()})}function ie(e){w(),y=e,F(),P=window.setInterval(()=>{y--,F(),y<=0&&(w(),document.getElementById("btn-show-answer")?.classList.add("hidden"),document.getElementById("answer-block")?.classList.remove("hidden"))},1e3)}function w(){P!==null&&(clearInterval(P),P=null)}function F(){let e=document.getElementById("timer-display");e&&(e.textContent=String(y),y<=5?e.className="text-6xl font-black text-red-500 leading-none":y<=10?e.className="text-6xl font-black text-yellow-400 leading-none":e.className="text-6xl font-black text-white leading-none")}function W(e){if(i){if(w(),e){i.totalStars+=i.pack.starsPerCorrect;let t=i.characterSet.characters,r=null;for(;i.unlockedUpTo+1<t.length&&i.totalStars>=t[i.unlockedUpTo+1].cost;)i.unlockedUpTo++,r=t[i.unlockedUpTo];if(H(i),r){let n=i.unlockedUpTo>=t.length-1?()=>{i.currentIndex++,j(i.id),oe(),h("results")}:()=>X();Se(r,n);return}}H(i),X()}}function Se(e,t){let r=document.createElement("div");r.className="fixed inset-0 bg-black/85 backdrop-blur-md flex items-center justify-center z-50";let a=e.imageUrl?b(e.imageUrl):"";r.innerHTML=`
  ...
  `,document.body.appendChild(r),r.querySelector("#btn-unlock-ok")?.addEventListener("click",()=>{r.remove(),t()})}function X(){if(i){if(i.currentIndex++,i.currentIndex>=i.shuffledQuestions.length){j(i.id),oe(),h("results");return}H(i),Q()}}function oe(){if(!i)return;let e=document.getElementById("screen-results"),t=i.characterSet.characters,r=i.unlockedUpTo>=0?t.slice(0,i.unlockedUpTo+1):[],a=i.unlockedUpTo>=0?t[i.unlockedUpTo]??null:null,n=(l,c)=>{let x=l?b(l):"";return x?`<img src="${x}" alt="" class="${c}" />`:`<div class="${c} bg-gray-700 flex items-center justify-center text-4xl">\u2B50</div>`};e.innerHTML=`
    <div class="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-950">
  ...
  `,e.querySelector("#btn-home")?.addEventListener("click",()=>{i=null,h("home")})}var B=()=>{};function le(e){B=e}var o=de();function de(){return{packs:[],view:"list",editIdx:-1,pack:{title:"",questions:[],starsPerCorrect:3},expandedQ:-1}}function ce(e){o=de(),o.packs=q(),$(e)}function $(e){o.view==="list"?O(e):$e(e)}function O(e){e.innerHTML=`
  ...
  `;let r=e.querySelector("#pe-title"),a=e.querySelector("#pe-stars");r.addEventListener("input",()=>{o.pack.title=r.value}),a.addEventListener("input",()=>{o.pack.starsPerCorrect=Math.max(1,parseInt(a.value)||1)}),e.querySelector("#pe-edit-back")?.addEventListener("click",()=>{o.view="list",o.packs=q(),$(e)}),e.querySelector("#pe-save")?.addEventListener("click",()=>{if(!o.pack.title.trim()){g("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043F\u0430\u043A\u0435\u0442\u0430");return}o.editIdx===-1?o.packs.push(o.pack):o.packs[o.editIdx]=o.pack,C(o.packs),o.view="list",$(e)}),e.querySelector("#pe-del-pack")?.addEventListener("click",()=>{g(`\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u0430\u043A\u0435\u0442 \xAB${d(o.pack.title)}\xBB?`,()=>{o.packs.splice(o.editIdx,1),C(o.packs),o.view="list",$(e)})}),e.querySelector("#pe-add-q")?.addEventListener("click",()=>{o.pack.questions.push({text:"",answer:"",imageUrl:""}),o.expandedQ=o.pack.questions.length-1,J(e),setTimeout(()=>{e.querySelector(`[data-qrow="${o.expandedQ}"]`)?.scrollIntoView({behavior:"smooth",block:"center"})},50)}),ue(e)}function xe(e){return e.length===0?'<div class="text-gray-500 text-center py-8 text-sm">\u041D\u0435\u0442 \u0432\u043E\u043F\u0440\u043E\u0441\u043E\u0432. \u041D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB+ \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C\xBB.</div>':e.map((t,r)=>{let a=o.expandedQ===r;return`
  ...
  `;let a=()=>{t.querySelectorAll("[data-resume]").forEach(n=>{n.addEventListener("click",()=>{t.remove(),ne(n.dataset.resume)})}),t.querySelectorAll("[data-delete]").forEach(n=>{n.addEventListener("click",()=>{g("\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u044D\u0442\u043E \u0441\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435?",()=>{j(n.dataset.delete);let l=t.querySelector("#sp-list");l&&(l.innerHTML=r()),a(),f().length===0&&(t.remove(),_())})})})};a(),t.querySelector("#sp-close")?.addEventListener("click",()=>t.remove()),t.addEventListener("click",n=>{n.target===t&&t.remove()}),document.body.appendChild(t)}async function qe(){te(T),le(T),await re(),T("home")}document.addEventListener("DOMContentLoaded",()=>{qe()});})();
